...
int pgaspi_dev_register_mem(gaspi_context_t const* const, gaspi_rc_mseg_t* seg);

int pgaspi_dev_unregister_mem(gaspi_context_t const* const, gaspi_rc_mseg_t*);

int pgaspi_dev_connect_context(gaspi_context_t const* const, const int);
